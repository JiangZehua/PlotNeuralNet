...
arch = [ 
    ...
    to_connection( "l2", "l3" ),
    to_Vector_nolabel( name='output', n_filer=10, offset="(9.3,0,0)", caption='Label', width=1, height=1, depth=1),
    # to_Vector_nolabel( name='output', n_filer=10, offset="(9.3,0,0)", caption='softmax', width=1, height=1, depth=1),
