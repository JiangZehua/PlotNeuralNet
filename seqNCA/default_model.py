...
arch = [ 
    ...
    to_FcRelu( name='l3', s_filer=1, n_filer=256, offset="(8.6,0,0)", caption="FC1--ReLu", width=2, depth=fc_height*1.5, height=fc_width),
    to_connection( "l2", "l3" ),
    to_FcRelu( name='l4', s_filer=1, n_filer=64, offset="(10.6,0,0)", caption="FC2--ReLu", width=2, depth=fc_height, height=fc_width),
    # to_Vector( name='l4', n_filer=256, width=fc_width, offset="(11.1,0,0)", caption="FC2", height=fc_height, depth=fc_width),
    to_connection( "l3", "l4" ),

    ###### action branch ######
    to_FcRelu( name='l51', n_filer=8, width=fc_width, offset="(14,2.5,0)", caption="ActionFC--ReLu", depth=fc_height/4, height=fc_width),
