...
arch = [ 
    ...
    to_ConvRelu( name='l1', s_filer=32, n_filer=64, offset="(-0.8,0,0)", width=conv_width, caption="Conv2D-7$\\times$7--ReLu", height=in_width, depth=in_width),
    to_connection( "input", "l1" ),
    to_ConvRelu( name='l2', s_filer=16, n_filer=64, width=conv_width, offset="(2.8,0,0)", caption="Conv2D-7$\\times$7--ReLu", height=in_width/2, depth=in_width/2),
    to_connection( "l1", "l2" ),
    # to_Vector( name='l3', n_filer=4096, width=fc_width, offset="(9.1,0,0)", caption="FC1", height=fc_height*2, depth=fc_width),
    to_FcRelu( name='l3', s_filer=1, n_filer=256, offset="(7.5,0,0)", caption="FC1--ReLu", width=fc_width, depth=fc_height*1.5, height=fc_width),
    to_connection( "l2", "l3" ),
    to_FcRelu( name='l4', s_filer=1, n_filer=64, offset="(9,0,0)", caption="FC2--ReLu", width=fc_width, depth=fc_height, height=fc_width),
    ...
    ###### value branch ######
    to_FcRelu( name='l52', n_filer=1, width=fc_width, offset="(12,-2.5,0)", caption="ValueFC--ReLu", depth=fc_width, height=fc_width),
