...
def to_LatentVector( name, s_filer=256, n_filer=64, offset="(0,0,0)", to="(0,0,0)", width=1, height=40, depth=40, caption=" " ):
    return r"""
\pic[shift={"""+ offset +"""}] at """+ to +""" 
    {LatentBox={
        name=""" + name +""",
...
# Conv, LeakyRelu
def to_ConvLeakyRelu( name, s_filer=256, n_filer=(64), offset="(0,0,0)", to="(0,0,0)", width=(2), height=40, depth=40, caption=" " ):
    return r"""
\pic[shift={ """+ offset +""" }] at """+ to +""" 
    {RightBandedBox={
        name="""+ name +""",
...
# Conv,sigmoid
def to_ConvSigmoid( name, s_filer=256, n_filer=(64), offset="(0,0,0)", to="(0,0,0)", width=(2), height=40, depth=40, caption=" " ):
    return r"""
\pic[shift={ """+ offset +""" }] at """+ to +""" 
    {RightBandedBox={
        name="""+ name +""",
...
# def to_top_manhattan_connection( of, to, pos=0.8): 
# #     return r"""
# # \draw [connection]  ("""+of+"""-northeast)    -- node {\midarrow} ("""+to+"""-west);
# # """
#     return r"""
# \draw [connection]  ("""+of+"""-east)   -- ++("""+ str(pos) +""",0) coordinate[midway] (midpoint) |- node[pos=0.75]  {\midarrow} ("""+to+"""-west);
# """
